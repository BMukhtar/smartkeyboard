package smartkeyboard.ime.text.gestures
...
private fun TextKey.baseCode(): Int {
    return (data as? KeyData)?.code ?: smartkeyboard.ime.text.key.KeyCode.UNSPECIFIED
}
...
class StatisticalGlideTypingClassifier(context: Context) : GlideTypingClassifier {
    ...
    private val lruSuggestionCache = LruCache<Pair<Gesture, Int>, List<String>>(

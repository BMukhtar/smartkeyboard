...
package smartkeyboard.ime.popup
        ...
        if (key is TextKey) {
            ...
            when (popupKeys.prioritized.size) {
                ...
                2 -> {
                    popupIndices[initUiIndex] = PopupKeys.FIRST_PRIORITIZED
                    when {
                        initUiIndex + 1 < n -> popupIndices[initUiIndex + 1] =
                            PopupKeys.SECOND_PRIORITIZED
                        initUiIndex - 1 >= 0 -> popupIndices[initUiIndex - 1] =
                            PopupKeys.SECOND_PRIORITIZED
                    }
                }

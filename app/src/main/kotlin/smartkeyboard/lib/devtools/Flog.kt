...
package smartkeyboard.lib.devtools
...
import smartkeyboard.lib.devtools.Flog.getStacktraceElement
import smartkeyboard.lib.devtools.Flog.log
...
object Flog {
    ...
    fun install(
        ...
        applicationContext = WeakReference(context.appContext().value)
        Flog.isFloggingEnabled = isFloggingEnabled
        Flog.flogTopics = flogTopics
        Flog.flogLevels = flogLevels
        Flog.flogOutputs = flogOutputs
    }

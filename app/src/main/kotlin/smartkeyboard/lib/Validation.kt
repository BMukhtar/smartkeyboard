...
package smartkeyboard.lib

import androidx.annotation.StringRes
import androidx.compose.runtime.Composable
import androidx.compose.runtime.remember
import smartkeyboard.lib.compose.stringRes
import smartkeyboard.lib.kotlin.CurlyArg
...
fun <T : Any> rememberValidationResult(rule: ValidationRule<T>, value: T): ValidationResult {
    return remember(value) {
        rule.validator.invoke(ValidationResult, value)
    }
}
...
fun <T : Any> validate(rule: ValidationRule<T>, value: T): ValidationResult {
    return rule.validator.invoke(ValidationResult, value)
}

...
import smartkeyboard.lib.ValidationRule
import smartkeyboard.lib.snygg.SnyggStylesheet
import smartkeyboard.lib.validate
...
object ExtensionValidation {
    ...
    val SnyggSolidColorValue = ValidationRule<String> {
        forKlass = smartkeyboard.lib.snygg.value.SnyggSolidColorValue::class
        forProperty = "color"
        validator { input ->
            val str = input.trim()
            when {
                str.isBlank() -> resultInvalid(error = "Please enter a color string")
                smartkeyboard.lib.snygg.value.SnyggSolidColorValue.deserialize(str).isFailure -> {
    ...
    val SnyggDpShapeValue = ValidationRule<String> {
        forKlass = smartkeyboard.lib.snygg.value.SnyggDpShapeValue::class
        forProperty = "corner"
        validator { str ->
    ...
    val SnyggPercentShapeValue = ValidationRule<String> {
        forKlass = smartkeyboard.lib.snygg.value.SnyggPercentShapeValue::class
        forProperty = "corner"
        validator { str ->
